...
class AddClosedQuoteToStatusOnServiceOrderTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    {
        Schema::table('dms_repair_order', function (Blueprint $table) {
            DB::statement("ALTER TABLE dms_repair_order MODIFY COLUMN status ENUM('picked_up','ready_for_pickup','on_tech_clipboard','waiting_custom','waiting_parts','warranty_processing','quote','work_available')");     
        });
    }
}