...
class CreateWebsiteFormFieldMap extends Migration
{
    ...
    public function up()
    {
        ...
        DB::table('website_form_field_map')->insertOrIgnore([
            ...
            ['type' => 'lead', 'form_field' => 'phone number', 'map_field' => 'phone_number', 'db_table' => 'website_lead', 'details' => NULL],
            ['type' => 'lead', 'form_field' => 'mobile phone', 'map_field' => 'phone_number', 'db_table' => 'website_lead', 'details' => NULL],
            ['type' => 'lead', 'form_field' => 'work phone', 'map_field' => 'phone_number', 'db_table' => 'website_lead', 'details' => NULL],
            ['type' => 'lead', 'form_field' => 'cell phone', 'map_field' => 'phone_number', 'db_table' => 'website_lead', 'details' => NULL],
            ['type' => 'lead', 'form_field' => 'daytime phone', 'map_field' => 'phone_number', 'db_table' => 'website_lead', 'details' => NULL],
            ['type' => 'lead', 'form_field' => 'evening phone', 'map_field' => 'phone_number', 'db_table' => 'website_lead', 'details' => NULL],
            ['type' => 'lead', 'form_field' => 'toll free phone', 'map_field' => 'phone_number', 'db_table' => 'website_lead', 'details' => NULL],
            ...
            ['type' => 'lead', 'form_field' => 'preferred location', 'map_field' => 'dealer_location_id', 'db_table' => 'website_lead', 'details' => NULL],
