...
class UpdateFmePostingHistoryView extends Migration
{
    /**
     * Run the migrations.
     *
        ...
        return "
            CREATE VIEW fme_posting_history AS
                    (SELECT fbl.id                                                                               AS record_id,
                            ...
                            IFNULL(inventory.stock, 'DELETED')                                                   AS SKU,
                            fbl.inventory_id,
                            fbl.facebook_id,
                            fbl.created_at
                ...
                UNION ALL
                    ...
                    FROM fbapp_errors as fbe
                              ...
                              LEFT JOIN inventory ON fbe.inventory_id = inventory.inventory_id
                              LEFT JOIN dealer_location ON fbapp_marketplace.dealer_location_id = dealer_location.dealer_location_id)
