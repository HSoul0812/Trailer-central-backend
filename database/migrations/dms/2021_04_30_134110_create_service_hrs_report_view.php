...
class CreateServiceHrsReportView extends Migration
{
    ...
    private function createView() : string
    {
        return "
          ...
          SELECT CONCAT(MONTHNAME(dms_repair_order.created_at), ' ', YEAR(dms_repair_order.created_at), ' (', `dms_repair_order`.`dealer_id`, ')') as month_name, qb_items.type, SUM(qb_invoice_items.unit_price) as unit_price, dms_repair_order.created_at, `dms_repair_order`.`dealer_id`
