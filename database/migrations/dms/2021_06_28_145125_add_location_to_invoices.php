...
class AddLocationToInvoices extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up(): void
    {
        Schema::table('qb_invoices', function (Blueprint $table) {
            ...
            $table->foreign('dealer_location_id','qb_invoices_dealer_location_id_foreign')
    ...
    {
        Schema::table('qb_invoices', function (Blueprint $table) {
            $table->dropForeign('qb_invoices_dealer_location_id_foreign');
