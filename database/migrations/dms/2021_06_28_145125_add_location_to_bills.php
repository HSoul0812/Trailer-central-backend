...
class AddLocationToBills extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up(): void
    {
        Schema::table('qb_bills', function (Blueprint $table) {
            ...
            $table->foreign('dealer_location_id', 'qb_bills_dealer_location_id_foreign')
    ...
    {
        Schema::table('qb_bills', function (Blueprint $table) {
            $table->dropForeign('qb_bills_dealer_location_id_foreign');
