...
class AddNewOptionOnlyReadyForPickupInDmsRepairOrderTable extends Migration
{
    ...
    public function up(): void
    {
        Schema::table($this->tableName, function (Blueprint $table) {
            ...
            DB::statement("ALTER TABLE $this->tableName MODIFY COLUMN status ENUM('picked_up','ready_for_pickup','on_tech_clipboard','waiting_custom','waiting_parts','warranty_processing','quote','work_available', 'closed_quote', '" . ServiceOrder::STATUS_ONLY_READY_FOR_PICKUP ."') NOT NULL");
        });
    }
