...
class AddGubagooIntegration extends Migration
{
    use SetupAndCheckNew;

    private const DEALER_ID = 10590;
    ...
    private $integration = [
        ...
        'module_status' => 'idle',
        'name' => 'Gubagoo',
        'description' => "List all your Cars on Gubagoo",
        'domain' => 'https://gubagoo.com',
        'create_account_url' => 'https://www.gubagoo.com/',
        'active' => 1,
        'filters' => 'a:0:{}',
        'frequency' => 21600,
        'settings' => 'a:0:{}',
