...
class CreateDealerIdsIntegration extends Migration
{
    use SetupAndCheckNew;

    private const DEALER_ID = 7435;

    private $integration = [
        'code' => 'dealershipids',
        'module_name' => 'dealershipids',
        'module_status' => 'idle',
        'name' => 'Dealership IDS',
        'description' => "List all your Cars on Dealership IDS",
        'domain' => 'http://dealershipids.com/',
        'create_account_url' => 'http://dealershipids.com/',
        'active' => 1,
        'filters' => 'a:0:{}',
        'frequency' => 21600,
        'settings' => 'a:0:{}',
    ...
    public function up()
    {
        ...
        $integrationId = 95; //$this->getNextId($this->integration['code']);
