...
class FixFbmeOverviewLastAttemptTs extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    private function createView2(): string
    {
        ...
        SELECT 
            ...
            IFNULL((SELECT CONCAT(created_at, ': ', error_message) FROM fbapp_errors WHERE marketplace_id=fbm.id ORDER BY id DESC LIMIT 1), 'no error') AS last_known_error,
