...
namespace Illuminate\Support\Facades {
    ...
    class Cache
    {
         ...
         * @static
         */
        public static function rememberWithNewTTL($key, $ttl, $callback)
        {
            return \Illuminate\Cache\Repository::rememberWithNewTTL($key, $ttl, $callback);
        }
    ...
    class Http
    {
        ...
        /**
         * @see \App\Providers\TrailerCentralIntegrationServiceProvider::boot()
         *
         * @static
         */
        public static function tcApi()
        {
            return \Illuminate\Http\Client\Factory::tcApi();
        }
    }
    /**
    ...
    class Schema
    {
         ...
         *
         * @param \Tpetry\PostgresqlEnhanced\Schema\array<string,  string>        $parameters
         * @param \Tpetry\PostgresqlEnhanced\Schema\array<string,  string>|string $return
