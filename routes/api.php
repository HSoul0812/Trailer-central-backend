...
$api->version('v1', function ($route) {
    ...
    */
    ...
    $route->group(['middleware' => 'text.template.validate'], function ($route) {
        $route->get('crm/{userId}/texts/template', 'App\Http\Controllers\v1\CRM\Texts\TemplateController@index')->where('userId', '[0-9]+');
        $route->put('crm/{userId}/texts/template', 'App\Http\Controllers\v1\CRM\Texts\TemplateController@create')->where('userId', '[0-9]+');
        $route->get('crm/{userId}/texts/template/{id}', 'App\Http\Controllers\v1\CRM\Texts\TemplateController@show')->where('userId', '[0-9]+')->where('id', '[0-9]+');
        $route->post('crm/{userId}/texts/template/{id}', 'App\Http\Controllers\v1\CRM\Texts\TemplateController@update')->where('userId', '[0-9]+')->where('id', '[0-9]+');
        $route->delete('crm/{userId}/texts/template/{id}', 'App\Http\Controllers\v1\CRM\Texts\TemplateController@destroy')->where('userId', '[0-9]+')->where('id', '[0-9]+');
    });
    ...
    $route->group(['middleware' => 'text.campaign.validate'], function ($route) {
        $route->get('crm/{userId}/texts/campaign', 'App\Http\Controllers\v1\CRM\Texts\CampaignController@index')->where('userId', '[0-9]+');
        $route->put('crm/{userId}/texts/campaign', 'App\Http\Controllers\v1\CRM\Texts\CampaignController@create')->where('userId', '[0-9]+');
        $route->get('crm/{userId}/texts/campaign/{id}', 'App\Http\Controllers\v1\CRM\Texts\CampaignController@show')->where('userId', '[0-9]+')->where('id', '[0-9]+');
        $route->post('crm/{userId}/texts/campaign/{id}', 'App\Http\Controllers\v1\CRM\Texts\CampaignController@update')->where('userId', '[0-9]+')->where('id', '[0-9]+');
        $route->delete('crm/{userId}/texts/campaign/{id}', 'App\Http\Controllers\v1\CRM\Texts\CampaignController@destroy')->where('userId', '[0-9]+')->where('id', '[0-9]+');
        $route->post('crm/{userId}/texts/campaign/{id}/sent', 'App\Http\Controllers\v1\CRM\Texts\CampaignController@sent')->where('userId', '[0-9]+')->where('id', '[0-9]+');
    });
    ...
    $route->group(['middleware' => 'text.blast.validate'], function ($route) {
        $route->get('crm/{userId}/texts/blast', 'App\Http\Controllers\v1\CRM\Texts\BlastController@index')->where('userId', '[0-9]+');
        $route->put('crm/{userId}/texts/blast', 'App\Http\Controllers\v1\CRM\Texts\BlastController@create')->where('userId', '[0-9]+');
        $route->get('crm/{userId}/texts/blast/{id}', 'App\Http\Controllers\v1\CRM\Texts\BlastController@show')->where('userId', '[0-9]+')->where('id', '[0-9]+');
        $route->post('crm/{userId}/texts/blast/{id}', 'App\Http\Controllers\v1\CRM\Texts\BlastController@update')->where('userId', '[0-9]+')->where('id', '[0-9]+');
        $route->delete('crm/{userId}/texts/blast/{id}', 'App\Http\Controllers\v1\CRM\Texts\BlastController@destroy')->where('userId', '[0-9]+')->where('id', '[0-9]+');
        $route->post('crm/{userId}/texts/blast/{id}/sent', 'App\Http\Controllers\v1\CRM\Texts\BlastController@sent')->where('userId', '[0-9]+')->where('id', '[0-9]+');
    });
