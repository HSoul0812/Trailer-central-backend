...
return [
    ...
    */
    ...
    'listings' => [
        ...
        'marketplaceButton' => env('FB_MARKETING_SELECTORS_LISTINGS_MARKETPLACE_BUTTON', 'div[data-pagelet=\"LeftRail\"] a[href*=\"facebook.com/marketplace/\"]:contains(\'Marketplace\')'),
