...
use Carbon\Carbon;
use Tests\database\seeds\Marketing\Craigslist\TransactionSeeder;
use Tests\TestCase;
...
{
    /**
     * @var TransactionSeeder
     *
     */
    private $seeder;

    /** @var string */
    private const API_URL = '/api/marketing/clapp/billing';
    ...
    {
        parent::setUp();
        $this->seeder = new TransactionSeeder();
    }
    ...
    /**
     * Test that the billing controller return structure is correct
     *
     * @group Marketing
     * @typeOfTest IntegrationTestCase
     *
     * @covers \App\Http\Controllers\v1\Marketing\Craigslist\BillingController::index
     *
     * @return void
     */
    public function testGettingBilling(): void
    {
