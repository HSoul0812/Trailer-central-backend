...
class UpdateTest extends AbstractDealerLocationController
{
    ...
    public function invalidParametersProvider(): array
    {
        ...
        return [                                                    // array $params, string $expectedException, string $expectedExceptionMessage, string|array $firstExpectedErrorMessage
            ...
            'No others required parameters'                         => [['dealer_id' => $this->getSeededData(0,'dealerId'), 'id' => $this->getSeededData(0, 'firstLocationId')], ResourceException::class, 'Validation Failed', ['name', 'contact', 'address', 'city', 'county', 'region', 'country', 'postalcode', 'phone', 'tax_calculator_id']],
