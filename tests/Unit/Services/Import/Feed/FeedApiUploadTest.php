...
/**
 * Test for \App\Repositories\Feed\FeedApiUploadRepository
 *
 * Class FeedApiUploadTest
 * @package Tests\Unit\Services\Import\Feed
 *
 * @coversDefaultClass \App\Repositories\Feed\FeedApiUploadsRepository
 */
class FeedApiUploadTest extends TestCase
{
     ...
     * @throws PropertyDoesNotExists
     */
    public function testInvalidAddInventory($code, $key, $type, $data) {
        $apiUpload = $this->getEloquentMock(FeedApiUpload::class);
