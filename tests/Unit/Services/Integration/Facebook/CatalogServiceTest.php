...
class CatalogServiceTest extends TestCase
{
    ...
    {
        // Get Test Catalog
        $catalog = $this->createCatalogAccessToken();
    ...
    private function createCatalogAccessToken()
    {
        ...
        $catalog->setRelation('accessToken', $accessToken);
        $catalog->setRelation('page', $page);
