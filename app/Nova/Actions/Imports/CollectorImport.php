    ...
    * @return Collector
    ...
    public function model(array $row): Collector
    {
        return new Collector([
            ...
            'use_secondary_image' => $row[23],
            'append_floorplan_image' => $row[24],
            ...
            'use_latest_ftp_file_only' => $row[46],
