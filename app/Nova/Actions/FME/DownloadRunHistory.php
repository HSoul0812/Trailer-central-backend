...
use App\Services\Dispatch\Facebook\InventoryOverviewServiceInterface;
...
class DownloadRunHistory extends Action
{
    ...
    /**
     * @var InventoryOverviewServiceInterface
     */
    private $service;

    public function __construct(InventoryOverviewServiceInterface $service)
    {
    ...
    public function handle(ActionFields $fields, Collection $models): array
    {
        ...
        try {
            return self::download(
                $this->service->export($fbmOverview->id, $fileName),
                $fileName
            );
    ...
    private function getFileName($dealerId): string
    {
        ...
        return "export_historyReport_{$dealerId}_{$date}.csv";
    }
}
