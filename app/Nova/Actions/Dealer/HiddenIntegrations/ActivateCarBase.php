...
class ActivateCarBase extends Action
{
    ...
    public $confirmText = 'Are you sure you want to activate CarBase?';
    ...
    public function handle(ActionFields $fields, Collection $models): void
    {
        ...
        foreach ($models as $model) {
            $result = $this->dealerOptionsService->activateCarBase($model->dealer_id);

            if (!$result) {
                throw new \InvalidArgumentException('CarBase activation error', 500);
            }
        }
    }
