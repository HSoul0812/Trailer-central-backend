...
class DeactivateELeads extends Action
{
    ...
    public $confirmText = 'Are you sure you want to activate E-Leads?';
    ...
    public function handle(ActionFields $fields, Collection $models): void
    {
        ...
        foreach ($models as $model) {
            $result = $this->dealerOptionsService->deactivateELeads($model->dealer_id);

            if (!$result) {
                throw new \InvalidArgumentException('E-Leads activation error', 500);
            }
        }
    }
