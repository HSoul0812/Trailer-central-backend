...
class ActivateTrailerUSA extends Action
{
    ...
    public $confirmText = 'Are you sure you want to activate TrailerUSA?';
    ...
    public function handle(ActionFields $fields, Collection $models): void
    {
        ...
        foreach ($models as $model) {
            $result = $this->dealerOptionsService->activateTrailerUSA($model->dealer_id);

            if (!$result) {
                throw new \InvalidArgumentException('TrailerUSA activation error', 500);
            }
        }
    }
