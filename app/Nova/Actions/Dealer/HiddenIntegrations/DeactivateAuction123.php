...
class DeactivateAuction123 extends Action
{
    ...
    public $confirmText = 'Are you sure you want to deactivate Auction123?';
    ...
    public function handle(ActionFields $fields, Collection $models): void
    {
        ...
        foreach ($models as $model) {
            $result = $this->dealerOptionsService->deactivateAuction123($model->dealer_id);

            if (!$result) {
                throw new \InvalidArgumentException('Auction123 deactivation error', 500);
            }
        }
    }
