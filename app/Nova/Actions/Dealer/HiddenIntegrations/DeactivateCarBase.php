...
class DeactivateCarBase extends Action
{
    ...
    public $confirmText = 'Are you sure you want to deactivate CarBase?';
    ...
    public function handle(ActionFields $fields, Collection $models): void
    {
        ...
        foreach ($models as $model) {
            $result = $this->dealerOptionsService->deactivateCarBase($model->dealer_id);

            if (!$result) {
                throw new \InvalidArgumentException('CarBase deactivation error', 500);
            }
        }
    }
