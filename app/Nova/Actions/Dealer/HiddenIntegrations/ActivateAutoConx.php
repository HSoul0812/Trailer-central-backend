...
class ActivateAutoConx extends Action
{
    ...
    public $confirmText = 'Are you sure you want to activate AutoConx?';
    ...
    public function handle(ActionFields $fields, Collection $models): void
    {
        ...
        foreach ($models as $model) {
            $result = $this->dealerOptionsService->activateAutoConx($model->dealer_id);

            if (!$result) {
                throw new \InvalidArgumentException('AutoConx activation error', 500);
            }
        }
    }
