...
class ActivateAuction123 extends Action
{
    ...
    public $confirmText = 'Are you sure you want to activate Auction123?';
    ...
    public function handle(ActionFields $fields, Collection $models): void
    {
        ...
        foreach ($models as $model) {
            $result = $this->dealerOptionsService->activateAuction123($model->dealer_id);

            if (!$result) {
                throw new \InvalidArgumentException('Auction123 activation error', 500);
            }
        }
    }
