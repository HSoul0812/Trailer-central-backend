...
class DeactivateTrailerUSA extends Action
{
    ...
    public $confirmText = 'Are you sure you want to deactivate TrailerUSA?';
    ...
    public function handle(ActionFields $fields, Collection $models): void
    {
        ...
        foreach ($models as $model) {
            $result = $this->dealerOptionsService->deactivateTrailerUSA($model->dealer_id);

            if (!$result) {
                throw new \InvalidArgumentException('TrailerUSA deactivation error', 500);
            }
        }
    }
