...
class ActivateScheduler extends Action
{
    ...
    public $confirmText = 'Are you sure you want to activate Scheduler?';
    ...
    public function handle(ActionFields $fields, Collection $models): void
    {
        ...
        foreach ($models as $model) {
            $result = $this->dealerOptionsService->activateScheduler($model->dealer_id);

            if (!$result) {
                throw new \InvalidArgumentException('Scheduler activation error', 500);
            }
        }
    }
