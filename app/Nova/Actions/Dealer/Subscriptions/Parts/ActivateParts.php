...
class ActivateParts extends Action
{
    ...
    public $confirmText = 'Are you sure you want to activate Parts?';
    ...
    public function handle(ActionFields $fields, Collection $models): void
    {
        ...
        foreach ($models as $model) {
            $result = $this->dealerOptionsService->activateParts($model->dealer_id);

            if (!$result) {
                throw new \InvalidArgumentException('Parts activation error', 500);
            }
        }
    }
