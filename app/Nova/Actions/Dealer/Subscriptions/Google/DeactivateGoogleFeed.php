...
class DeactivateGoogleFeed extends Action
{
    ...
    public $confirmText = 'Are you sure you want to deactivate Google Feed?';
    ...
    public function handle(ActionFields $fields, Collection $models): void
    {
        ...
        foreach ($models as $model) {
            $result = $this->dealerOptionsService->deactivateGoogleFeed($model->dealer_id);

            if (!$result) {
                throw new \InvalidArgumentException('Google Feed deactivation error', 500);
            }
        }
    }
