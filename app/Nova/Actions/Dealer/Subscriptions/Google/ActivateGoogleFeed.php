...
class ActivateGoogleFeed extends Action
{
    ...
    public $confirmText = 'Are you sure you want to activate Google Feed?';
    ...
    public function handle(ActionFields $fields, Collection $models): void
    {
        ...
        foreach ($models as $model) {
            $result = $this->dealerOptionsService->activateGoogleFeed($model->dealer_id);

            if (!$result) {
                throw new \InvalidArgumentException('Google Feed activation error', 500);
            }
        }
    }
