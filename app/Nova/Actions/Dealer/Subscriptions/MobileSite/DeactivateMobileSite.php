...
class DeactivateMobileSite extends Action
{
    ...
    public $confirmText = 'Are you sure you want to deactivate MobileSite?';
    ...
    public function handle(ActionFields $fields, Collection $models): void
    {
        ...
        foreach ($models as $model) {
            $result = $this->dealerOptionsService->deactivateMobile($model->dealer_id);

            if (!$result) {
                throw new \InvalidArgumentException('Mobile deactivation error', 500);
            }
        }
    }
