...
class InteractionsController extends RestfulControllerV2
{
    ...
    public function __construct(
        ...
        $this->middleware('setDealerIdOnRequest')->only(['sendEmail', 'getEmailDraft', 'saveEmailDraft', 'sendEmailDraft', 'getReplyEmailDraft']);
        $this->middleware('setSalesPersonIdOnRequest')->only(['sendEmail', 'getEmailDraft', 'saveEmailDraft', 'sendEmailDraft', 'getReplyEmailDraft']);
