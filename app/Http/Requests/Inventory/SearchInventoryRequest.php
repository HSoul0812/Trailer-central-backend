...
class SearchInventoryRequest extends Request
{
    ...
    public function getRules(): array
    {
        return [
            ...
            'geolocation.range' => ['numeric'],
            'geolocation.units' => [Rule::in([GeolocationRange::UNITS_MILES, GeolocationRange::UNITS_KILOMETERS])],
            'geolocation.grouping' => [Rule::in([GeolocationRange::GROUPING_RANGE, GeolocationRange::GROUPING_UNITS])],
