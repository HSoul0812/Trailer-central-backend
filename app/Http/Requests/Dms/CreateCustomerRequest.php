...
class CreateCustomerRequest extends Request
{
    protected function getRules(): array
    {
        return [
            ...
            'home_phone' => ['string', 'nullable', new ValidStringCharacters(ValidStringCharacters::CUSTOMERS_PHONE_SECTION), 'max:20'],
            'work_phone' => ['string', 'nullable', new ValidStringCharacters(ValidStringCharacters::CUSTOMERS_PHONE_SECTION), 'max:20'],
            'cell_phone' => ['string', 'nullable', new ValidStringCharacters(ValidStringCharacters::CUSTOMERS_PHONE_SECTION), 'max:20'],
            ...
            'postal_code' => ['string', 'nullable', new ValidStringCharacters(ValidStringCharacters::CUSTOMERS_POSTAL_CODE_SECTION), 'max:10'],
