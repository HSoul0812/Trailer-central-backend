...
class CreateCustomerRequest extends Request
{
    protected function getRules(): array
    {
        return [
            ...
            'home_phone' => ['string', 'nullable', new ValidStringCharacters(ValidStringCharacters::CUSTOMERS_PHONE_SECTION)],
            'work_phone' => ['string', 'nullable', new ValidStringCharacters(ValidStringCharacters::CUSTOMERS_PHONE_SECTION)],
            'cell_phone' => ['string', 'nullable', new ValidStringCharacters(ValidStringCharacters::CUSTOMERS_PHONE_SECTION)],
            ...
            'postal_code' => ['string', 'nullable', new ValidStringCharacters(ValidStringCharacters::CUSTOMERS_POSTAL_CODE_SECTION)],
