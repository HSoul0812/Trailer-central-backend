...
class RemoveDeletedPartsFromESIndex extends Command
{
     ...
     * php artisan crm:dms:remove-deleted-parts-from-es-index 1001
     *
     * Call with a specified size 500 per page
     * php artisan crm:dms:remove-deleted-parts-from-es-index 1001 500
     *
     * @var string
     */
    protected $signature = '
        crm:dms:remove-deleted-parts-from-es-index 
     ...
     * @return int
     */
    public function handle(RemoveDeletedModelFromESIndexAction $action): int
    {
