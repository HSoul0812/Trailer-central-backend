...
use App\Repositories\Showroom\ShowroomFeatureRepository;
...
use App\Repositories\Showroom\ShowroomFileRepository;
use App\Repositories\Showroom\ShowroomFileRepositoryInterface;
use App\Repositories\Showroom\ShowroomGenericMapRepository;
use App\Repositories\Showroom\ShowroomGenericMapRepositoryInterface;
use App\Repositories\Showroom\ShowroomImageRepository;
...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        \Validator::extendDependent('lead_trade_valid', 'App\Rules\CRM\Leads\ValidLeadTrade@passes');
        ...
        \Validator::extend('dealer_location_inquiry_valid', 'App\Rules\CRM\Leads\ValidDealerLocationInquiry@passes');
    ...
    public function register()
    {
        ...
        $this->app->bind(ShowroomServiceInterface::class, ShowroomService::class);
        $this->app->bind(ShowroomGenericMapRepositoryInterface::class, ShowroomGenericMapRepository::class);
        $this->app->bind(ShowroomFeatureRepositoryInterface::class, ShowroomFeatureRepository::class);
        $this->app->bind(ShowroomFileRepositoryInterface::class, ShowroomFileRepository::class);
        $this->app->bind(ShowroomImageRepositoryInterface::class, ShowroomImageRepository::class);
