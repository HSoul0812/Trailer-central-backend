...
use App\Services\Integration\Google\GoogleGmailInterface;
...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function register()
    {
        ...
        $this->app->bind(GoogleClientInterface::class, Google_Client::class);
        $this->app->bind(GoogleGmailInterface::class, Google_Service_Gmail::class);
