...
class DealerLocation extends Model
{
    ...
    /**
     * This is only used to load geolocation values for Nova
     * @return BelongsTo
     */
    public function possibleGeolocationByZip(): BelongsTo
    {
        return $this->belongsTo(Geolocation::class, 'zip', 'postalcode');
    }
}
