...
class InquiryEmailService implements InquiryEmailServiceInterface
{
    ...
    public function createFromLead(Lead $lead) : InquiryLead
    {
        ...
        $params['lead_types'] = [$lead->lead_type];
        $params['inventory'] = [$lead->inventory_id];
        ...
        $params['metadata'] = $lead->address;
        $params['date_submitted'] = $lead->city;
        $params['contact_email_sent'] = $lead->state;
        $params['adf_email_sent'] = $lead->zip;
        $params['cdk_email_sent'] = $lead->comments;
        $params['is_spam'] = $lead->note;        
