...
class UserTransformer extends TransformerAbstract
{
    ...
    public function transform($user): array
    {
        return [
             ...
             'is_crm_active' => $user->is_crm_active ?? $user->user->is_crm_active ?? false,
             'is_parts_active' => $user->is_parts_active ?? $user->user->is_parts_active ?? false,
             'is_marketing_active' => $user->is_marketing_active ?? $user->user->is_marketing_active ?? false,
