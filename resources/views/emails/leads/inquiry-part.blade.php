            ...
            <table bgcolor="{{ $bgcolor }}" cellpadding="0" cellspacing="0" border="0" width="650" style="border:1px solid #E0E0E0;">
                ...
                <tr>
                    <td valign="top">
                        ...
                        <h3 style="font-size:16px; line-height:16px; font-family:Verdana, Arial, Helvetica, sans-serif;">New Part Information Request on {{ $website }}</h3>

                        <p style="font-size:12px; line-height:16px; font-family:Verdana, Arial, Helvetica, sans-serif;">Part Stock: <strong>{{ $inventory_stock }}</strong></p>

                        <p style="font-size:12px; line-height:16px; font-family:Verdana, Arial, Helvetica, sans-serif;">Part Item: <a href="{{ $inventory_url }}"><strong>{{ $inventory_title }}</strong></a></p>
